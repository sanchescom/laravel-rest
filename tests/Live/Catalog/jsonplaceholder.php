...
return [
    ...
    'scenarios' => [
        ...
        'nested post comments' => ['probe' => 'has-many', 'model' => Post::class, 'id' => 1, 'relation' => 'nestedComments', 'nested' => true, 'foreign_key' => 'postId', 'path_suffix' => 'posts/1/comments'],
        'eager comments' => ['probe' => 'eager', 'model' => Post::class, 'query' => fn (Builder $query) => $query->limit(5), 'relation' => 'comments', 'mode' => 'concurrent', 'foreign_key' => 'postId'],
        'eager authors' => ['probe' => 'eager', 'model' => Post::class, 'query' => fn (Builder $query) => $query->limit(25), 'relation' => 'author', 'mode' => 'concurrent', 'foreign_key' => 'userId'],
